...
import (
	...
	"market/pkg/model"
	"market/pkg/service"
	mocks "market/pkg/service/mocks"
	"net/http/httptest"
	"testing"
...
func TestHandler_signUp(t *testing.T) {
	type mockBehaviour func(ru *mocks.MockUser, rc *mocks.MockCart, user model.User)
	...
	tests := []struct {
	...
	}{
		{
			...
			mockBehaviour: func(ru *mocks.MockUser, rc *mocks.MockCart, user model.User) {
		...
		},
		{
			...
			mockBehaviour:        func(r *mocks.MockUser, rc *mocks.MockCart, user model.User) {},
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			repoUser := mocks.NewMockUser(c)
			repoCart := mocks.NewMockCart(c)
...
func TestHandler_signIn(t *testing.T) {
	type mockBehaviour func(r *mocks.MockUser, inp signInInput)
	...
	tests := []struct {
	...
	}{
		{
			...
			mockBehaviour: func(r *mocks.MockUser, inp signInInput) {
